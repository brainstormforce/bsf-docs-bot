...
export default function Chat() {
	...
	const Source = ({ source }) => {
		...
		return (
			<div className="relative flex flex-row items-center space-x-3 rounded-lg border border-gray-300 bg-white p-3 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:border-gray-400">
	...
	return (
		<div id="ask" className="relative">
			<div className="mx-auto px-6 text-center lg:px-8">
				...
				<div className="mt-10 flex flex-col gap-4 max-[600px]:mt-8">
					...
					{loading ? (
						...
						<form
							...
							disabled={loading}
						>
							<div className="mt-1 mb-8 w-full rounded-md sm:flex bdb-search-wrapper">
								<div className="relative flex w-full flex-grow items-stretch bdb-search-inner-wrap">
									<input
										type="text"
										name="query"
										id="query"
				...
				{resultHtml && (
					<>
						<div className="relative mt-10 rounded-sm p-5 bg-[#F6FAFE] border border-solid border-[#E2E8F0] text-left sm:rounded-md">
							{answerId && (
							...
							<div className="min-w-full">
								...
								<div
									...
									className="wpchat-code prose mt-3 max-w-[90ch]"
								/>
							</div>
						</div>
						...
						{sources?.length > 0 && (
							<div className="relative text-left mt-8 pt-1 grid grid-cols-1 gap-4">
								...
								{
									bsf_bot_localizer.support_link && (
										<p className='mb-0'>
											<a
